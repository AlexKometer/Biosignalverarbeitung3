...
def import_data(separator):
   ...
   """
    ...
    for i in range(3):
        ...
        weights_string = 'data/data_schorsch/Weight' + str(i + 1) + '.csv'
        mvc_string = 'data/data_schorsch/MVC' + str(i + 1) + '.csv'
        fatigue_string = 'data/data_schorsch/Fatigue' + str(i + 1) + '.csv'
